...
<body>
    ...
    <input type="button" onclick="window.location='uk.php'" class="Redirect" value="UK 🇬🇧"/> <br/> <br/>
    <input type="button" onclick="window.location='rd.php'" class="Redirect" value="República Dominicana 🇩🇴"/> <br/> <br/>
